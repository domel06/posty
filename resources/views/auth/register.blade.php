...
<div class="flex justify-center">
        <div class="w-4/12 bg-white p-8 mb-4 rounded-lg">
            <form action="{{ route('register') }}" method="post">
             @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repeat your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confimation') border-red-500 @enderror " value="">
